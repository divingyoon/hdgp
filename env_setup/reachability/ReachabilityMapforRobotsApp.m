classdef ReachabilityMapforRobotsApp < handle
    %
    % Usage:
    %     app.ReachabilityMapforRobotsApp
    ...
    properties (Constant)
        AppPathBase = {'/ReachabilityMapforRobots'};
        AppClass = 'ReachabilityMapforRobotsApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = ReachabilityMapforRobotsApp()
        ...
        function startApp(obj)
            ...
            mlock;
            ReachabilityMapforRobotsApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'ReachabilityGenerator')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong ReachabilityGenerator
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'ReachabilityGenerator').getString, ...
            ...
            if nargout(@ReachabilityGenerator) == 0
                eval('ReachabilityGenerator');
            else
                obj.AppHandle = eval('ReachabilityGenerator');
            end
