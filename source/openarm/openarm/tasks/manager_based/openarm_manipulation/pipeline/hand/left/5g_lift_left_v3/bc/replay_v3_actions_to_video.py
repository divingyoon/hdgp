#!/usr/bin/env python3
"""Replay v3 action sequence and record rendered frames to an MP4 video."""
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Replay actions in v3 env and record video.")
    parser.add_argument("--task", type=str, default="5g_lift_left-v3")
