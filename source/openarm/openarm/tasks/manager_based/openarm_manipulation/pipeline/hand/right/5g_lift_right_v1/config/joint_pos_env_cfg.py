...
@configclass
class OpenArmLift5gRightEnvCfg(Lift5gRightEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.commands.object_pose.body_name = "rl_dg_ee"
        self.commands.object_pose.ranges.pitch = (math.pi / 2, math.pi / 2)
        # Match test1 regularization strengths.


@configclass
class OpenArmLift5gRightEnvCfg_PLAY(OpenArmLift5gRightEnvCfg):
    def __post_init__(self):
        super().__post_init__()
