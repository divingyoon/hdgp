...
class Approach5gHoldEnv(ManagerBasedRLEnv):
    """Approach env with 2g-style inactive-arm action masking."""
    ...
    def _setup_curriculum_masking(self) -> None:
        ...
        if "left_hand_action" in self._action_slices:
            ...
            # FingerSynergyAction maps -1 to open and +1 to close.
    ...
    def step(self, action: torch.Tensor):
        ...
        if self.mask_inactive_arm:
            ...
            if stage == 0:  # LEFT_ONLY: freeze right side
                if "right_arm_action" in self._action_slices:
            ...
            elif stage == 1:  # RIGHT_ONLY: freeze left side
                if "left_arm_action" in self._action_slices:
