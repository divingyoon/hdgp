...
@configclass
class OpenArmApproachRightEnvCfg(ApproachRightEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.robot = ArticulationCfg(
            ...
            init_state=ArticulationCfg.InitialStateCfg(
                ...
                rot=[1.0, 0.0, 0.0, 0.0],
                joint_pos={
                    # Match non-hand initial joints with 2g_grasp_right_v1.
...
@configclass
class OpenArmApproachRightEnvCfg_PLAY(OpenArmApproachRightEnvCfg):
    def __post_init__(self):
        super().__post_init__()
