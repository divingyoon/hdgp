...
gym.register(
    id="5g_lift_right-v1",
    entry_point="openarm.tasks.manager_based.openarm_manipulation.pipeline.hand.right.5g_lift_right_v1.lift_right_hold_env:Lift5gHoldEnv",
