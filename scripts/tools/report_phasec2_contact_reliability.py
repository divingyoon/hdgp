#!/usr/bin/env python3
"""Report Phase C2 contact reliability metrics for 5g_grasp_right-v2."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Validate contact reliability metrics.")
...
def main() -> int:
    ...
    def _run(env_cfg, _agent_cfg):
        ...
        tracked_keys = [
            "tip_contact_force",
            "tip_object_contact_force",
            "tip_table_contact_force",
            "tip_object_contact_rate",
            "tip_table_contact_rate",
            "tip_contact_force_valid_rate",
            "tip_contact_fallback_used_rate",
            "tip_object_fallback_dist",
            "tip_table_fallback_margin",
        ]
