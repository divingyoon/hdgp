#!/usr/bin/env python3
"""Validate Phase C1 contact-split metrics for 5g_grasp_right-v2."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Validate contact split metrics with short rollout.")
